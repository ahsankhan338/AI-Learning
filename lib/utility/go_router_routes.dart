...
class AppRoutes {
  ...
  static const certificate = AppRoute(path: '/certificate', name: 'certificate');
  ...
  static const certificateDetail = AppRoute(path: '/certificate/:id', name: 'certificateDetail');

  // Profile Sub-routes
  static const profileSettings = AppRoute(path: '/profile/settings', name: 'profileSettings');
}
